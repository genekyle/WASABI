...
async def hover_and_click(page: Page, xpath: str, hover_pause_type: Optional[str] = None, click_pause_type: Optional[str] = None):
    """Random wait, hover over an element, random wait, then click it."""
